	...
	return (
		...
		>
			...
			<Text h3 color="$accents9" css={{ textAlign: "center" }}>
				A web app that empowers victims of data weapons to document and
				share their experiences through personal testimonies.
			</Text>
			<Container css={{ mt: "$2" }}>
				<Table
				...
				>
					...
					<Table.Body>
						<Table.Row key="1" css={{ color: "$accents9" }}>
							<Table.Cell>Spring 2022: Jan-May</Table.Cell>
							<Table.Cell>Web Dev, React & TypeScript</Table.Cell>
							<Table.Cell>
